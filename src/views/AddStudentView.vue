  ...
  <div class="container">
    <div class="row pb-5">
      <div class="col-lg-6 col-md-8 login-box">
        <div class="col-lg-12 login-title">Add Student</div>
    ...
    <div class="row text-center">
      <div class="col col-lg-3" v-for="item in studentsData" :key="item.index">
        <div>
          <img
  ...
  uploadTask.on(
    ...
    () => {
      getDownloadURL(uploadTask.snapshot.ref).then((URL) => {
        ...
        createToast("Save student success", {
          type: "success",
        });
        setTimeout(() => {
          name.value = "";
